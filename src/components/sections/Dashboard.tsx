            ...
            <div className="flex items-center space-x-6 mb-6">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  <h4 className="font-bold text-white text-lg">Compliance</h4>
                  <Tooltip>
                    <TooltipTrigger asChild>
                    ...
                    <TooltipContent className="bg-gray-800 border-gray-600 text-gray-200 max-w-sm p-4">
                      <div className="space-y-2">
                        <p className="font-semibold">Compliance Score: 95%</p>
                        <p>Based on:</p>
                ...
                <p className="text-gray-400">Valid documents uploaded</p>
              </div>
            </div>
            <Tooltip>
              <TooltipTrigger asChild>
        ...
        <Card className="bg-gray-900/60 border-gray-700/50 hover:bg-gray-800/60 transition-all duration-300 backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="flex items-center space-x-6 mb-6">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  <h4 className="font-bold text-white text-lg">Performance</h4>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <HelpCircle className="h-4 w-4 text-gray-400 hover:text-white cursor-help" />
                    </TooltipTrigger>
                    <TooltipContent className="bg-gray-800 border-gray-600 text-gray-200 max-w-sm p-4">
                      <div className="space-y-2">
                        <p className="font-semibold">Performance Score: 72%</p>
                        <p>Based on:</p>
                        <ul className="text-sm space-y-1 ml-4">
        ...
        <Card className="bg-gray-900/60 border-gray-700/50 hover:bg-gray-800/60 transition-all duration-300 backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="flex items-center space-x-6 mb-6">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  <h4 className="font-bold text-white text-lg">Reputation</h4>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <HelpCircle className="h-4 w-4 text-gray-400 hover:text-white cursor-help" />
                    </TooltipTrigger>
                    <TooltipContent className="bg-gray-800 border-gray-600 text-gray-200 max-w-sm p-4">
                      <div className="space-y-2">
                        <p className="font-semibold">Reputation Score: 88%</p>
                        <p>Based on:</p>
                        <ul className="text-sm space-y-1 ml-4">
  ...
  return (
    <Card className="bg-gray-900/60 border-gray-700/50 backdrop-blur-sm">
      ...
      <CardContent>
        ...
        <div className="mt-8">
          <h4 className="font-semibold text-white mb-4">Recent Documents</h4>
    ...
    <Card className="bg-gradient-to-br from-emerald-600 to-green-700 border-emerald-500/50 backdrop-blur-sm">
      <CardContent className="p-8">
        <div className="text-center">
          ...
          <h3 className="font-bold text-white mb-3 text-xl">Invite Partners</h3>
